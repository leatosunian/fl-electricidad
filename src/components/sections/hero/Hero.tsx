...
export default function Hero() {
  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center pt-20 overflow-hidden bg-neutral-950">
      {/* Background Texture */}
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
        ...
        >
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 bg-primary text-on-primary text-[10px] font-bold tracking-[0.2em] uppercase mb-8"
          >
            Tu instalación eléctrica, en buenas manos.
          </motion.div>
          <motion.h1
            variants={itemVariants}
            className="font-headline text-5xl md:text-7xl lg:text-8xl font-black text-white leading-[0.9] tracking-tighter mb-6 uppercase"
          >
            Soluciones{" "}
          ...
          <motion.p
            variants={itemVariants}
            className="text-neutral-400 text-lg md:text-xl max-w-xl mb-10 font-body leading-relaxed"
          >
            Reparamos, diseñamos e instalamos sistemas eléctricos seguros, eficientes y adaptados a tus necesidades
          </motion.p>
